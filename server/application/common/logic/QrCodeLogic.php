...
class QrCodeLogic{
    ...
    public function userShareConfig()
    {
        return [
            ...
            //会员昵称
            'nickname' => [
                'color' => '#333333', 'font_face' => './font/PingFang_Regular.ttf', 'font_size' => 20, 'x' => 120, 'y' => 730,
            ],
            //标题
            'title' => [
                'color' => '#333333', 'font_face' => './font/PingFang_Regular.ttf', 'font_size' => 20, 'w' => 360, 'x' => 30, 'y' => 810,
            ],
            //提醒长按扫码
            'notice' => [
                'color' => '#333333', 'font_face' => './font/PingFang_Regular.ttf', 'font_size' => 20, 'x' => 30, 'y' => 880,
            ],
            //邀请码文本
            'code_text' => [
                'color' => '#FF2C3C', 'font_face' => './font/PingFang_Regular.ttf', 'font_size' => 20, 'x' => 355, 'y' => 930,
            ],
            //二维码
            'qr' => [
    ...
    public function makeUserMnpQrcode($code,$content,$img_src)
    {
        try {
            $config = WeChatServer::getMnpConfig();
            $app = Factory::miniProgram($config);
            $response = $app->app_code->get('invite_code='.$code, [
                'page'  => $content,
                'width' => 170,
            ]);
