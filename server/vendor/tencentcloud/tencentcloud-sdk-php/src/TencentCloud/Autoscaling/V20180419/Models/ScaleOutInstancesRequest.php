 ...
 * @method integer getScaleOutNumber() 获取希望扩容的实例数量。
 * @method void setScaleOutNumber(integer $ScaleOutNumber) 设置希望扩容的实例数量。
 */
class ScaleOutInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var integer 希望扩容的实例数量。
     */
    public $ScaleOutNumber;

    /**
     * @param string $AutoScalingGroupId 伸缩组ID。
     * @param integer $ScaleOutNumber 希望扩容的实例数量。
     */
