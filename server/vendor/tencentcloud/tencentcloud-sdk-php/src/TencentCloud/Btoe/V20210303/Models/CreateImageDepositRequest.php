 ...
 * @method string getFileName() 获取对应数据Base64文件名称 test.png
 * @method void setFileName(string $FileName) 设置对应数据Base64文件名称 test.png
...
class CreateImageDepositRequest extends AbstractModel
{
    ...
    /**
     * @var string 对应数据Base64文件名称 test.png
     */
    public $FileName;
     ...
     * @param string $FileName 对应数据Base64文件名称 test.png
