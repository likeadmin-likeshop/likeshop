 ...
 * @method integer getThrough() 获取票据验证的通过量
 * @method void setThrough(integer $Through) 设置票据验证的通过量
 */
class TicketThroughUnit extends AbstractModel
{
    ...
    /**
     * @var integer 票据验证的通过量
     */
    public $Through;

    /**
     * @param string $DateKey 时间
     * @param integer $Through 票据验证的通过量
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Through",$param) and $param["Through"] !== null) {
            $this->Through = $param["Through"];
        }
    }
}
