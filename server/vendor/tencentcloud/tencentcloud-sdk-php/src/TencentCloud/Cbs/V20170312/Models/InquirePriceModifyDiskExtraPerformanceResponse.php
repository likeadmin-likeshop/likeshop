 ...
 *
 * @method Price getDiskPrice() 获取描述了调整云盘额外性能时对应的价格。
 * @method void setDiskPrice(Price $DiskPrice) 设置描述了调整云盘额外性能时对应的价格。
...
class InquirePriceModifyDiskExtraPerformanceResponse extends AbstractModel
{
    ...
    /**
     * @param Price $DiskPrice 描述了调整云盘额外性能时对应的价格。
