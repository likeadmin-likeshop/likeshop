 ...
 *
 * @method PSTNSession getSession() 获取会话信息
 * @method void setSession(PSTNSession $Session) 设置会话信息
...
class DescribeTelSessionResponse extends AbstractModel
{
    ...
    /**
     * @param PSTNSession $Session 会话信息
