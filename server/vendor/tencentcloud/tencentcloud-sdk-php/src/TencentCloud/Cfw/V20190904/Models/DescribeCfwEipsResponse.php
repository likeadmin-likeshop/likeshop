...
class DescribeCfwEipsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("NatFwEipList",$param) and $param["NatFwEipList"] !== null) {
            $this->NatFwEipList = [];
            foreach ($param["NatFwEipList"] as $key => $value){
                $obj = new NatFwEipsInfo();
                $obj->deserialize($value);
                array_push($this->NatFwEipList, $obj);
            }
        }
