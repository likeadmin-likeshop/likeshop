 ...
 * @method array getAccessGroupIds() 获取绑定的权限组ID列表
 * @method void setAccessGroupIds(array $AccessGroupIds) 设置绑定的权限组ID列表
 */
class MountPoint extends AbstractModel
{
     ...
     * @param array $AccessGroupIds 绑定的权限组ID列表
     */
