...
class DescribeClusterResourcesResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ClusterResourceSet",$param) and $param["ClusterResourceSet"] !== null) {
            $this->ClusterResourceSet = [];
            foreach ($param["ClusterResourceSet"] as $key => $value){
                $obj = new ClusterResource();
                $obj->deserialize($value);
                array_push($this->ClusterResourceSet, $obj);
            }
        }
