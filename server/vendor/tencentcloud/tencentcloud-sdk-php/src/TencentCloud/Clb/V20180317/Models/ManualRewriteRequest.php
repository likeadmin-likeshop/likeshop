 ...
 * @method string getSourceListenerId() 获取源监听器 ID。
 * @method void setSourceListenerId(string $SourceListenerId) 设置源监听器 ID。
 * @method string getTargetListenerId() 获取目标监听器 ID。
 * @method void setTargetListenerId(string $TargetListenerId) 设置目标监听器 ID。
...
class ManualRewriteRequest extends AbstractModel
{
     ...
     * @param string $SourceListenerId 源监听器 ID。
     * @param string $TargetListenerId 目标监听器 ID。
