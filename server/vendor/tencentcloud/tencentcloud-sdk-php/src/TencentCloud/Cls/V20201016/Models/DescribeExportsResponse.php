 ...
 *
 * @method array getExports() 获取日志导出列表
 * @method void setExports(array $Exports) 设置日志导出列表
...
class DescribeExportsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Exports",$param) and $param["Exports"] !== null) {
            $this->Exports = [];
            foreach ($param["Exports"] as $key => $value){
                $obj = new ExportInfo();
                $obj->deserialize($value);
                array_push($this->Exports, $obj);
            }
        }
