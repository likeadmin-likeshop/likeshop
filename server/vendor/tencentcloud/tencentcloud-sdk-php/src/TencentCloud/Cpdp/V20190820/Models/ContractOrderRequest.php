 ...
 * @method string getContractNotifyUrl() 获取签约通知地址
 * @method void setContractNotifyUrl(string $ContractNotifyUrl) 设置签约通知地址
 ...
 * @method string getContractSceneId() 获取传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
 * @method void setContractSceneId(string $ContractSceneId) 设置传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
 * @method string getExternalContractData() 获取需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
 * @method void setExternalContractData(string $ExternalContractData) 设置需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
 * @method string getOutContractCode() 获取外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
 * @method void setOutContractCode(string $OutContractCode) 设置外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
 * @method string getAttachData() 获取透传给第三方渠道的附加数据
 * @method void setAttachData(string $AttachData) 设置透传给第三方渠道的附加数据
 * @method string getContractDisplayName() 获取展示用的签约用户名称，若不传入时，默认取UserId
 * @method void setContractDisplayName(string $ContractDisplayName) 设置展示用的签约用户名称，若不传入时，默认取UserId
 */
...
缺省: release
    ...
    /**
     * @var string 传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
     */
    public $ContractSceneId;

    /**
     * @var string 需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
     */
    public $ExternalContractData;

    /**
     * @var string 外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
     */
    public $OutContractCode;

    /**
     * @var string 透传给第三方渠道的附加数据
     */
    public $AttachData;

    /**
     * @var string 展示用的签约用户名称，若不传入时，默认取UserId
     */
    public $ContractDisplayName;
     ...
     * @param string $ContractNotifyUrl 签约通知地址
...
缺省: release
     ...
     * @param string $ContractSceneId 传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
     * @param string $ExternalContractData 需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
     * @param string $OutContractCode 外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
     * @param string $AttachData 透传给第三方渠道的附加数据
     * @param string $ContractDisplayName 展示用的签约用户名称，若不传入时，默认取UserId
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ContractNotifyUrl",$param) and $param["ContractNotifyUrl"] !== null) {
            $this->ContractNotifyUrl = $param["ContractNotifyUrl"];
        }
        ...
        if (array_key_exists("SubOrderList",$param) and $param["SubOrderList"] !== null) {
            ...
            foreach ($param["SubOrderList"] as $key => $value){
                $obj = new ContractOrderInSubOrder();
        ...
        if (array_key_exists("AttachData",$param) and $param["AttachData"] !== null) {
            $this->AttachData = $param["AttachData"];
        }

        if (array_key_exists("ContractDisplayName",$param) and $param["ContractDisplayName"] !== null) {
            $this->ContractDisplayName = $param["ContractDisplayName"];
        }
    }
}
