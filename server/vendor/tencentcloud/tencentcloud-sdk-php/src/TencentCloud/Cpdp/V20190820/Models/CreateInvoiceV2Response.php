 ...
 *
 * @method CreateInvoiceResultV2 getResult() 获取发票开具结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(CreateInvoiceResultV2 $Result) 设置发票开具结果
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var CreateInvoiceResultV2 发票开具结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
    ...
    /**
     * @param CreateInvoiceResultV2 $Result 发票开具结果
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CreateInvoiceResultV2();
