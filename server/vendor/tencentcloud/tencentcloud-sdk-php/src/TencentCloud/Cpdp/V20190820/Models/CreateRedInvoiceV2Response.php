 ...
 *
 * @method CreateRedInvoiceResultV2 getResult() 获取红冲结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(CreateRedInvoiceResultV2 $Result) 设置红冲结果
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var CreateRedInvoiceResultV2 红冲结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
    ...
    /**
     * @param CreateRedInvoiceResultV2 $Result 红冲结果
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CreateRedInvoiceResultV2();
