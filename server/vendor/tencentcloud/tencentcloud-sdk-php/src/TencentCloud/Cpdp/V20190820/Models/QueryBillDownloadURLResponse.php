 ...
 * @method QueryBillDownloadURLData getResult() 获取返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(QueryBillDownloadURLData $Result) 设置返回结果
注意：此字段可能返回 null，表示取不到有效值。
...
class QueryBillDownloadURLResponse extends AbstractModel
{
    ...
    /**
     * @var QueryBillDownloadURLData 返回结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param QueryBillDownloadURLData $Result 返回结果
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QueryBillDownloadURLData();
