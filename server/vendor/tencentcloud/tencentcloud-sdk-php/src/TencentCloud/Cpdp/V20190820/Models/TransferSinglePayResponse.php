 ...
 * @method TransferSinglePayData getResult() 获取返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(TransferSinglePayData $Result) 设置返回结果
注意：此字段可能返回 null，表示取不到有效值。
...
class TransferSinglePayResponse extends AbstractModel
{
    ...
    /**
     * @var TransferSinglePayData 返回结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param TransferSinglePayData $Result 返回结果
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new TransferSinglePayData();
