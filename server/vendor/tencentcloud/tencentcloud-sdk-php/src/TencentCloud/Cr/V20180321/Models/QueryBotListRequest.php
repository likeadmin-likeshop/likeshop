 ...
 * @method string getOperation() 获取操作名：QueryBotList
 * @method void setOperation(string $Operation) 设置操作名：QueryBotList
 */
class QueryBotListRequest extends AbstractModel
{
    ...
    /**
     * @var string 操作名：QueryBotList
     */
    public $Operation;

    /**
     * @param string $Module 模块名：AiApi
     * @param string $Operation 操作名：QueryBotList
     */
