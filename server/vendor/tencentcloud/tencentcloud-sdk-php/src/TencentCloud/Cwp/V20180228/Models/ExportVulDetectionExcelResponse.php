 ...
 * @method string getTaskId() 获取导出本次漏洞检测Excel的任务Id（不同于入参的本次漏洞检测任务id）
 * @method void setTaskId(string $TaskId) 设置导出本次漏洞检测Excel的任务Id（不同于入参的本次漏洞检测任务id）
...
class ExportVulDetectionExcelResponse extends AbstractModel
{
    ...
    /**
     * @var string 导出本次漏洞检测Excel的任务Id（不同于入参的本次漏洞检测任务id）
     */
    public $TaskId;
     ...
     * @param string $TaskId 导出本次漏洞检测Excel的任务Id（不同于入参的本次漏洞检测任务id）
