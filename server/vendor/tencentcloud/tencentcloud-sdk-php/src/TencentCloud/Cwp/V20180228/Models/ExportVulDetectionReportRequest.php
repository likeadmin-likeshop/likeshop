 ...
 *
 * @method integer getTaskId() 获取漏洞扫描任务id（不同于出参的导出检测报告的任务Id）
 * @method void setTaskId(integer $TaskId) 设置漏洞扫描任务id（不同于出参的导出检测报告的任务Id）
...
{
    /**
     * @var integer 漏洞扫描任务id（不同于出参的导出检测报告的任务Id）
     */
    public $TaskId;
    ...
    /**
     * @param integer $TaskId 漏洞扫描任务id（不同于出参的导出检测报告的任务Id）
