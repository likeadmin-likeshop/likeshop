 ...
 *
 * @method string getReportUrl() 获取健康报告浏览地址。
 * @method void setReportUrl(string $ReportUrl) 设置健康报告浏览地址。
 * @method integer getExpireTime() 获取健康报告浏览地址到期时间戳（秒）。
 * @method void setExpireTime(integer $ExpireTime) 设置健康报告浏览地址到期时间戳（秒）。
