 ...
 *
 * @method integer getTotalCount() 获取互联网公网地址统计信息数量
 * @method void setTotalCount(integer $TotalCount) 设置互联网公网地址统计信息数量
 * @method array getInternetAddressStatistics() 获取互联网公网地址统计信息列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInternetAddressStatistics(array $InternetAddressStatistics) 设置互联网公网地址统计信息列表
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var integer 互联网公网地址统计信息数量
     */
    public $TotalCount;

    /**
     * @var array 互联网公网地址统计信息列表
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    /**
     * @param integer $TotalCount 互联网公网地址统计信息数量
     * @param array $InternetAddressStatistics 互联网公网地址统计信息列表
注意：此字段可能返回 null，表示取不到有效值。
