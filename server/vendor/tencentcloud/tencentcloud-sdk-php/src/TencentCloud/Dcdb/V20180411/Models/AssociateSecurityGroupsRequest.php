 ...
 * @method array getInstanceIds() 获取被绑定的实例ID，类似tdsqlshard-lesecurk，支持指定多个实例。
 * @method void setInstanceIds(array $InstanceIds) 设置被绑定的实例ID，类似tdsqlshard-lesecurk，支持指定多个实例。
 */
class AssociateSecurityGroupsRequest extends AbstractModel
{
    ...
    /**
     * @var array 被绑定的实例ID，类似tdsqlshard-lesecurk，支持指定多个实例。
     */
    public $InstanceIds;
     ...
     * @param array $InstanceIds 被绑定的实例ID，类似tdsqlshard-lesecurk，支持指定多个实例。
     */
