 ...
 *
 * @method array getDatabaseList() 获取数据库对象列表。
 * @method void setDatabaseList(array $DatabaseList) 设置数据库对象列表。
...
class DescribeDatabasesResponse extends AbstractModel
{
    ...
    /**
     * @param array $DatabaseList 数据库对象列表。
