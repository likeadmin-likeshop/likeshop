 ...
 *
 * @method array getLineList() 获取线路列表。
 * @method void setLineList(array $LineList) 设置线路列表。
 * @method array getLineGroupList() 获取线路分组列表。
 * @method void setLineGroupList(array $LineGroupList) 设置线路分组列表。
...
class DescribeRecordLineListResponse extends AbstractModel
{
    ...
    /**
     * @param array $LineList 线路列表。
     * @param array $LineGroupList 线路分组列表。
