 ...
 * @method string getLockCode() 获取域名解锁码，锁定的时候会返回。
 * @method void setLockCode(string $LockCode) 设置域名解锁码，锁定的时候会返回。
...
class ModifyDomainUnlockRequest extends AbstractModel
{
     ...
     * @param string $LockCode 域名解锁码，锁定的时候会返回。
