 ...
 * @method array getDomainBatchDetailSet() 获取日志详情列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDomainBatchDetailSet(array $DomainBatchDetailSet) 设置日志详情列表。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $DomainBatchDetailSet 日志详情列表。
注意：此字段可能返回 null，表示取不到有效值。
