 ...
 * @method array getDomainBatchLogSet() 获取日志列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDomainBatchLogSet(array $DomainBatchLogSet) 设置日志列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $DomainBatchLogSet 日志列表
注意：此字段可能返回 null，表示取不到有效值。
