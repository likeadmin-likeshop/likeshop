 ...
 *
 * @method array getIpv6AddressSet() 获取分配给弹性网卡的IPv6地址列表。
 * @method void setIpv6AddressSet(array $Ipv6AddressSet) 设置分配给弹性网卡的IPv6地址列表。
...
class AssignIpv6AddressesResponse extends AbstractModel
{
    ...
    /**
     * @param array $Ipv6AddressSet 分配给弹性网卡的IPv6地址列表。
