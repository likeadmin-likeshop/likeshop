 ...
 * @method array getIpv6Addresses() 获取指定的IPv6地址信息。
 * @method void setIpv6Addresses(array $Ipv6Addresses) 设置指定的IPv6地址信息。
 */
class ModifyIpv6AddressesAttributeRequest extends AbstractModel
{
     ...
     * @param array $Ipv6Addresses 指定的IPv6地址信息。
     */
