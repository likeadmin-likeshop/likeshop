 ...
 * @method string getSecurityGroup() 获取安全组ID，如 esg-12345678
 * @method void setSecurityGroup(string $SecurityGroup) 设置安全组ID，如 esg-12345678
...
class SetSecurityGroupForLoadbalancersRequest extends AbstractModel
{
    ...
    /**
     * @var string 安全组ID，如 esg-12345678
     */
...
DEL 解绑安全组
     ...
     * @param string $SecurityGroup 安全组ID，如 esg-12345678
