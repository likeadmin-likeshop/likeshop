...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FleetCapacity",$param) and $param["FleetCapacity"] !== null) {
            $this->FleetCapacity = [];
            foreach ($param["FleetCapacity"] as $key => $value){
                $obj = new FleetCapacity();
                $obj->deserialize($value);
                array_push($this->FleetCapacity, $obj);
            }
        }
