 ...
 *
 * @method array getInstanceTypeList() 获取服务器实例类型列表
 * @method void setInstanceTypeList(array $InstanceTypeList) 设置服务器实例类型列表
...
class DescribeInstanceTypesResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceTypeList 服务器实例类型列表
