 ...
 *
 * @method array getTimerScalingPolicies() 获取定时器扩缩容策略配置
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTimerScalingPolicies(array $TimerScalingPolicies) 设置定时器扩缩容策略配置
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotalCount() 获取定时器总数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotalCount(integer $TotalCount) 设置定时器总数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $TimerScalingPolicies 定时器扩缩容策略配置
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $TotalCount 定时器总数
注意：此字段可能返回 null，表示取不到有效值。
