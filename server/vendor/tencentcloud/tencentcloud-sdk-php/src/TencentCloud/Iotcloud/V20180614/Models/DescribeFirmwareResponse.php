 ...
 * @method string getFwType() 获取固件类型。选项：mcu、module
 * @method void setFwType(string $FwType) 设置固件类型。选项：mcu、module
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $FwType 固件类型。选项：mcu、module
