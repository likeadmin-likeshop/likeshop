 ...
 *
 * @method array getTaskInfos() 获取资源任务列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTaskInfos(array $TaskInfos) 设置资源任务列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotal() 获取资源任务总数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotal(integer $Total) 设置资源任务总数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $TaskInfos 资源任务列表
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Total 资源任务总数
注意：此字段可能返回 null，表示取不到有效值。
