 ...
 *
 * @method boolean getIsRenew() 获取标志是否为续订
 * @method void setIsRenew(boolean $IsRenew) 设置标志是否为续订
...
4：等待服务生效。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IsRenew",$param) and $param["IsRenew"] !== null) {
            $this->IsRenew = $param["IsRenew"];
        }
