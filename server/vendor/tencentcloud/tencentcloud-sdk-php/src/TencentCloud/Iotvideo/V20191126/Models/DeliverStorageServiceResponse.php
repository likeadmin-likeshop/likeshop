 ...
 *
 * @method string getSrcServiceId() 获取被转出的云存服务ID
 * @method void setSrcServiceId(string $SrcServiceId) 设置被转出的云存服务ID
 * @method string getServiceId() 获取被转入的云存服务ID
 * @method void setServiceId(string $ServiceId) 设置被转入的云存服务ID
...
{
    /**
     * @var string 被转出的云存服务ID
     */
    public $SrcServiceId;

    /**
     * @var string 被转入的云存服务ID
     */
    public $ServiceId;
...
4：等待服务生效。
    ...
    /**
     * @param string $SrcServiceId 被转出的云存服务ID
     * @param string $ServiceId 被转入的云存服务ID
