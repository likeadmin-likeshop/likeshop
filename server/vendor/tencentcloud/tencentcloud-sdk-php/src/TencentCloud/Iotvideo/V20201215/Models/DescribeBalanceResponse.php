 ...
 *
 * @method integer getBalance() 获取账户余额，单位：分（人民币）。
 * @method void setBalance(integer $Balance) 设置账户余额，单位：分（人民币）。
...
class DescribeBalanceResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Balance 账户余额，单位：分（人民币）。
