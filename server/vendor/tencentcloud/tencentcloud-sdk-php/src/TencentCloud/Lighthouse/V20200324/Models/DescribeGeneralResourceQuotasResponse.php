 ...
 *
 * @method array getGeneralResourceQuotaSet() 获取通用资源配额详细信息列表。
 * @method void setGeneralResourceQuotaSet(array $GeneralResourceQuotaSet) 设置通用资源配额详细信息列表。
...
class DescribeGeneralResourceQuotasResponse extends AbstractModel
{
    ...
    /**
     * @param array $GeneralResourceQuotaSet 通用资源配额详细信息列表。
