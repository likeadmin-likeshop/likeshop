 ...
 * @method array getResetInstanceBlueprintSet() 获取镜像重置信息列表
 * @method void setResetInstanceBlueprintSet(array $ResetInstanceBlueprintSet) 设置镜像重置信息列表
...
class DescribeResetInstanceBlueprintsResponse extends AbstractModel
{
     ...
     * @param array $ResetInstanceBlueprintSet 镜像重置信息列表
