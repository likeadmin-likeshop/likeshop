 ...
 *
 * @method array getSnapshotIds() 获取要查询快照的 ID 列表。
参数不支持同时指定 SnapshotIds 和 Filters。
 * @method void setSnapshotIds(array $SnapshotIds) 设置要查询快照的 ID 列表。
参数不支持同时指定 SnapshotIds 和 Filters。
...
每次请求的 Filters 的上限为 10，Filter.Values 的上限为 5。参数不支持同时指定 SnapshotIds 和 Filters。
    ...
    /**
     * @param array $SnapshotIds 要查询快照的 ID 列表。
参数不支持同时指定 SnapshotIds 和 Filters。
