 ...
 * @method string getInstanceName() 获取实例名称。可任意命名，但不得超过 60 个字符。
 * @method void setInstanceName(string $InstanceName) 设置实例名称。可任意命名，但不得超过 60 个字符。
 */
class ModifyInstancesAttributeRequest extends AbstractModel
{
    ...
    /**
     * @var string 实例名称。可任意命名，但不得超过 60 个字符。
     */
    public $InstanceName;
     ...
     * @param string $InstanceName 实例名称。可任意命名，但不得超过 60 个字符。
     */
