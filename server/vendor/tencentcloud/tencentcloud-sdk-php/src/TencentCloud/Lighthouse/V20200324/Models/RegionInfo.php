 ...
 * @method string getRegionState() 获取地域是否可用状态，取值仅为AVAILABLE。
 * @method void setRegionState(string $RegionState) 设置地域是否可用状态，取值仅为AVAILABLE。
 * @method boolean getIsChinaMainland() 获取是否中国大陆地域
 * @method void setIsChinaMainland(boolean $IsChinaMainland) 设置是否中国大陆地域
 */
class RegionInfo extends AbstractModel
{
    ...
    /**
     * @var string 地域是否可用状态，取值仅为AVAILABLE。
     */
    public $RegionState;

    /**
     * @var boolean 是否中国大陆地域
     */
     ...
     * @param string $RegionState 地域是否可用状态，取值仅为AVAILABLE。
     * @param boolean $IsChinaMainland 是否中国大陆地域
     */
