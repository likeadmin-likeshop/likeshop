 ...
 * @method integer getDuration() 获取当前加速剩余时长（单位秒）
 * @method void setDuration(integer $Duration) 设置当前加速剩余时长（单位秒）
...
class CreateQosResponse extends AbstractModel
{
     ...
     * @param integer $Duration 当前加速剩余时长（单位秒）
