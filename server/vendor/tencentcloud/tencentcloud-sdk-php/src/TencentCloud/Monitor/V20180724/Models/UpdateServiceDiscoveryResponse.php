 ...
 *
 * @method ServiceDiscoveryItem getServiceDiscovery() 获取更新成功之后，返回对应服务发现的信息
 * @method void setServiceDiscovery(ServiceDiscoveryItem $ServiceDiscovery) 设置更新成功之后，返回对应服务发现的信息
...
{
    /**
     * @var ServiceDiscoveryItem 更新成功之后，返回对应服务发现的信息
     */
    ...
    /**
     * @param ServiceDiscoveryItem $ServiceDiscovery 更新成功之后，返回对应服务发现的信息
