 ...
 *
 * @method array getResourceSet() 获取资源详细信息集合
 * @method void setResourceSet(array $ResourceSet) 设置资源详细信息集合
...
class DescribeSystemResourcesResponse extends AbstractModel
{
    ...
    /**
     * @param array $ResourceSet 资源详细信息集合
