 ...
 *
 * @method integer getTotalCount() 获取私有域数量
 * @method void setTotalCount(integer $TotalCount) 设置私有域数量
 * @method array getPrivateZoneSet() 获取私有域列表
 * @method void setPrivateZoneSet(array $PrivateZoneSet) 设置私有域列表
...
class DescribePrivateZoneListResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 私有域数量
     * @param array $PrivateZoneSet 私有域列表
