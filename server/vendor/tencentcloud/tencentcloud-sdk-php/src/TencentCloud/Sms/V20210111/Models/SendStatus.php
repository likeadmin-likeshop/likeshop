 ...
 * @method string getCode() 获取短信请求错误码，具体含义请参考 [错误码](https://cloud.tencent.com/document/product/382/49316)。
 * @method void setCode(string $Code) 设置短信请求错误码，具体含义请参考 [错误码](https://cloud.tencent.com/document/product/382/49316)。
...
class SendStatus extends AbstractModel
{
    ...
    /**
     * @var string 短信请求错误码，具体含义请参考 [错误码](https://cloud.tencent.com/document/product/382/49316)。
     */
    public $Code;
     ...
     * @param string $Code 短信请求错误码，具体含义请参考 [错误码](https://cloud.tencent.com/document/product/382/49316)。
