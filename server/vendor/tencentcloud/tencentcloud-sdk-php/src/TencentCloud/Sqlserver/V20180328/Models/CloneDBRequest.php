 ...
 * @method array getRenameRestore() 获取按照ReNameRestoreDatabase中的库进行克隆，并重命名，新库名称必须指定
 * @method void setRenameRestore(array $RenameRestore) 设置按照ReNameRestoreDatabase中的库进行克隆，并重命名，新库名称必须指定
 */
class CloneDBRequest extends AbstractModel
{
    ...
    /**
     * @var array 按照ReNameRestoreDatabase中的库进行克隆，并重命名，新库名称必须指定
     */
    public $RenameRestore;

    /**
     * @param string $InstanceId 实例ID，形如mssql-j8kv137v
     * @param array $RenameRestore 按照ReNameRestoreDatabase中的库进行克隆，并重命名，新库名称必须指定
     */
