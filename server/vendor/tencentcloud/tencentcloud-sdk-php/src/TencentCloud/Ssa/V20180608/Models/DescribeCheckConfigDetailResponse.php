 ...
 *
 * @method CheckConfigDetail getCheckConfigDetail() 获取检查项详情
 * @method void setCheckConfigDetail(CheckConfigDetail $CheckConfigDetail) 设置检查项详情
...
class DescribeCheckConfigDetailResponse extends AbstractModel
{
    ...
    /**
     * @param CheckConfigDetail $CheckConfigDetail 检查项详情
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CheckConfigDetail",$param) and $param["CheckConfigDetail"] !== null) {
            $this->CheckConfigDetail = new CheckConfigDetail();
