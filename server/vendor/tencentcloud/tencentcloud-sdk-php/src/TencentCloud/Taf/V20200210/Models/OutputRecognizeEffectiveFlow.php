...
注意：此字段可能返回 null，表示取不到有效值。
 * @method OutputRecognizeEffectiveFlowValue getValue() 获取业务入参
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setValue(OutputRecognizeEffectiveFlowValue $Value) 设置业务入参
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var OutputRecognizeEffectiveFlowValue 业务入参
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Value;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param OutputRecognizeEffectiveFlowValue $Value 业务入参
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Value",$param) and $param["Value"] !== null) {
            $this->Value = new OutputRecognizeEffectiveFlowValue();
