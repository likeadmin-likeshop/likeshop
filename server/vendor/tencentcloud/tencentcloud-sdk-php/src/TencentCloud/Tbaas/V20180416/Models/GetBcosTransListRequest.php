 ...
 * @method integer getPageNumber() 获取当前页数，默认是1
 * @method void setPageNumber(integer $PageNumber) 设置当前页数，默认是1
 ...
 * @method string getTransHash() 获取交易哈希，可以从InvokeBcosTrans接口的返回值中解析获取
 * @method void setTransHash(string $TransHash) 设置交易哈希，可以从InvokeBcosTrans接口的返回值中解析获取
 */
class GetBcosTransListRequest extends AbstractModel
{
    ...
    /**
     * @var string 交易哈希，可以从InvokeBcosTrans接口的返回值中解析获取
     */
    public $TransHash;
