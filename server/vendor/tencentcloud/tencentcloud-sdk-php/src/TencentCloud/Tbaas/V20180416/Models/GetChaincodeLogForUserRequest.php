 ...
 * @method string getOperation() 获取操作名，本接口取值：chaincode_log_for_user
 * @method void setOperation(string $Operation) 设置操作名，本接口取值：chaincode_log_for_user
...
class GetChaincodeLogForUserRequest extends AbstractModel
{
    ...
    /**
     * @var string 操作名，本接口取值：chaincode_log_for_user
     */
    public $Operation;
     ...
     * @param string $Operation 操作名，本接口取值：chaincode_log_for_user
