 ...
 *
 * @method array getProjectVersions() 获取版本列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setProjectVersions(array $ProjectVersions) 设置版本列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $ProjectVersions 版本列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ProjectVersions",$param) and $param["ProjectVersions"] !== null) {
            $this->ProjectVersions = [];
            foreach ($param["ProjectVersions"] as $key => $value){
                $obj = new CloudBaseProjectVersion();
                $obj->deserialize($value);
                array_push($this->ProjectVersions, $obj);
            }
        }
