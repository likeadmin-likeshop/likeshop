 ...
 *
 * @method array getVpcSet() 获取vpc私有域名解析状态列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setVpcSet(array $VpcSet) 设置vpc私有域名解析状态列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $VpcSet vpc私有域名解析状态列表
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("VpcSet",$param) and $param["VpcSet"] !== null) {
            ...
            foreach ($param["VpcSet"] as $key => $value){
                $obj = new VpcPrivateDomainStatus();
