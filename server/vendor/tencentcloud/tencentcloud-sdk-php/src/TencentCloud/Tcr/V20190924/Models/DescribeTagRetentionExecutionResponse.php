 ...
 *
 * @method array getRetentionExecutionList() 获取版本保留执行记录列表
 * @method void setRetentionExecutionList(array $RetentionExecutionList) 设置版本保留执行记录列表
 * @method integer getTotalCount() 获取版本保留执行记录总数
 * @method void setTotalCount(integer $TotalCount) 设置版本保留执行记录总数
...
{
    /**
     * @var array 版本保留执行记录列表
     */
    public $RetentionExecutionList;

    /**
     * @var integer 版本保留执行记录总数
     */
    public $TotalCount;
    ...
    /**
     * @param array $RetentionExecutionList 版本保留执行记录列表
     * @param integer $TotalCount 版本保留执行记录总数
