 ...
 *
 * @method array getStackIds() 获取按照⼀个或者多个资源栈ID查询
 * @method void setStackIds(array $StackIds) 设置按照⼀个或者多个资源栈ID查询
...
class DescribeStacksRequest extends AbstractModel
{
    ...
    /**
     * @param array $StackIds 按照⼀个或者多个资源栈ID查询
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("StackIds",$param) and $param["StackIds"] !== null) {
            $this->StackIds = $param["StackIds"];
        }
