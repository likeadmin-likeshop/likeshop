 ...
 * @method string getVersionId() 获取待执行destroy事件的版本ID
 * @method void setVersionId(string $VersionId) 设置待执行destroy事件的版本ID
 */
class DestroyStackRequest extends AbstractModel
{
    ...
    /**
     * @var string 待执行destroy事件的版本ID
     */
    public $VersionId;

    /**
     * @param string $StackId 资源栈ID
     * @param string $VersionId 待执行destroy事件的版本ID
     */
