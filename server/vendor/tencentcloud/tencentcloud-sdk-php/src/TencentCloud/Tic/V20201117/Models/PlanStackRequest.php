 ...
 * @method string getVersionId() 获取待执行plan事件的版本ID
 * @method void setVersionId(string $VersionId) 设置待执行plan事件的版本ID
 */
class PlanStackRequest extends AbstractModel
{
    ...
    /**
     * @var string 待执行plan事件的版本ID
     */
    public $VersionId;

    /**
     * @param string $StackId 资源栈ID
     * @param string $VersionId 待执行plan事件的版本ID
     */
