 ...
 * @method string getCallbackKey() 获取设置视频生成回调鉴权密钥，最长64字符，如果传入空字符串，那么删除现有的鉴权回调密钥
 * @method void setCallbackKey(string $CallbackKey) 设置设置视频生成回调鉴权密钥，最长64字符，如果传入空字符串，那么删除现有的鉴权回调密钥
 */
class SetVideoGenerationTaskCallbackKeyRequest extends AbstractModel
{
    ...
    /**
     * @var string 设置视频生成回调鉴权密钥，最长64字符，如果传入空字符串，那么删除现有的鉴权回调密钥
     */
    public $CallbackKey;

    /**
     * @param integer $SdkAppId 应用的SdkAppId
     * @param string $CallbackKey 设置视频生成回调鉴权密钥，最长64字符，如果传入空字符串，那么删除现有的鉴权回调密钥
     */
