 ...
 * @method string getTaskId() 获取需要停止的白板推流任务 Id
 * @method void setTaskId(string $TaskId) 设置需要停止的白板推流任务 Id
 */
class StopWhiteboardPushRequest extends AbstractModel
{
    ...
    /**
     * @var string 需要停止的白板推流任务 Id
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId 客户的SdkAppId
     * @param string $TaskId 需要停止的白板推流任务 Id
     */
