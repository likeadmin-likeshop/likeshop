 ...
 *
 * @method array getCommonNames() 获取子账户Uin与其客户端证书的CN字段映射
 * @method void setCommonNames(array $CommonNames) 设置子账户Uin与其客户端证书的CN字段映射
...
{
    /**
     * @var array 子账户Uin与其客户端证书的CN字段映射
     */
    public $CommonNames;
    ...
    /**
     * @param array $CommonNames 子账户Uin与其客户端证书的CN字段映射
