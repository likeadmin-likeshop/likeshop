 ...
 *
 * @method array getNodePoolSet() 获取NodePools（节点池列表）
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setNodePoolSet(array $NodePoolSet) 设置NodePools（节点池列表）
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $NodePoolSet NodePools（节点池列表）
注意：此字段可能返回 null，表示取不到有效值。
