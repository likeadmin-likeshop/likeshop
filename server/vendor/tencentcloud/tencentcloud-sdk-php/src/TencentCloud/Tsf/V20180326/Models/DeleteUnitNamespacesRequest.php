 ...
 * @method array getUnitNamespaceList() 获取单元化命名空间ID数组
 * @method void setUnitNamespaceList(array $UnitNamespaceList) 设置单元化命名空间ID数组
 */
class DeleteUnitNamespacesRequest extends AbstractModel
{
    ...
    /**
     * @var array 单元化命名空间ID数组
     */
    public $UnitNamespaceList;

    /**
     * @param string $GatewayInstanceId 网关实体ID
     * @param array $UnitNamespaceList 单元化命名空间ID数组
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UnitNamespaceList",$param) and $param["UnitNamespaceList"] !== null) {
            $this->UnitNamespaceList = $param["UnitNamespaceList"];
        }
    }
}
