 ...
 * SearchImage返回参数结构体
 *
 * @method string getFaceId() 获取face id
 * @method void setFaceId(string $FaceId) 设置face id
 * @method array getResults() 获取搜索结果列表
 * @method void setResults(array $Results) 设置搜索结果列表
