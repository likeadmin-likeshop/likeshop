 ...
 *
 * @method string getBizType() 获取业务ID，仅限英文字母、数字和下划线（_）组成，长度不超过8位
 * @method void setBizType(string $BizType) 设置业务ID，仅限英文字母、数字和下划线（_）组成，长度不超过8位
 ...
 * @method array getModerationCategories() 获取审核内容，可选：Polity (政治); Porn (色情); Illegal(违法);Abuse (谩骂); Terror (暴恐); Ad (广告); Custom (自定义);
 * @method void setModerationCategories(array $ModerationCategories) 设置审核内容，可选：Polity (政治); Porn (色情); Illegal(违法);Abuse (谩骂); Terror (暴恐); Ad (广告); Custom (自定义);
 */
class CreateBizConfigRequest extends AbstractModel
{
    /**
     * @var string 业务ID，仅限英文字母、数字和下划线（_）组成，长度不超过8位
     */
    public $BizType;
    ...
    /**
     * @var array 审核内容，可选：Polity (政治); Porn (色情); Illegal(违法);Abuse (谩骂); Terror (暴恐); Ad (广告); Custom (自定义);
     */
    public $ModerationCategories;

    /**
     * @param string $BizType 业务ID，仅限英文字母、数字和下划线（_）组成，长度不超过8位
     * @param MediaModerationConfig $MediaModeration 审核分类信息
     * @param string $BizName 业务名称，用于标识业务场景，长度不超过32位
     * @param array $ModerationCategories 审核内容，可选：Polity (政治); Porn (色情); Illegal(违法);Abuse (谩骂); Terror (暴恐); Ad (广告); Custom (自定义);
     */
