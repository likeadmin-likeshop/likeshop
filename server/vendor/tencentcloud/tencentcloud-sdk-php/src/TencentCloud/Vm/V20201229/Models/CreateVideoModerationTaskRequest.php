 ...
 * @method string getBizType() 获取业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
 * @method void setBizType(string $BizType) 设置业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
 * @method string getSeed() 获取（可选）回调签名key，具体可以查看回调签名示例
 * @method void setSeed(string $Seed) 设置（可选）回调签名key，具体可以查看回调签名示例
...
class CreateVideoModerationTaskRequest extends AbstractModel
{
    ...
    /**
     * @var string 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
     */
    public $BizType;

    /**
     * @var string （可选）回调签名key，具体可以查看回调签名示例
     */
    public $Seed;
     ...
     * @param string $BizType 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
     * @param string $Seed （可选）回调签名key，具体可以查看回调签名示例
