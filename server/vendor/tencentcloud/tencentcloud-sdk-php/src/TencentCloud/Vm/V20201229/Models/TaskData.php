...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getSuggestion() 获取建议，可选：Pass， Block 和 Review
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSuggestion(string $Suggestion) 设置建议，可选：Pass， Block 和 Review
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string 建议，可选：Pass， Block 和 Review
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Suggestion;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Suggestion 建议，可选：Pass， Block 和 Review
注意：此字段可能返回 null，表示取不到有效值。
