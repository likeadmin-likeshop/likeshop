 ...
 *
 * @method SendStatus getSendStatus() 获取语音验证码发送状态。
 * @method void setSendStatus(SendStatus $SendStatus) 设置语音验证码发送状态。
...
class SendCodeVoiceResponse extends AbstractModel
{
    ...
    /**
     * @param SendStatus $SendStatus 语音验证码发送状态。
