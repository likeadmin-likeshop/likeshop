 ...
 *
 * @method array getDefinitions() 获取图片处理模板标识列表。长度限制：100。
 * @method void setDefinitions(array $Definitions) 设置图片处理模板标识列表。长度限制：100。
...
<li>Custom：用户自定义模板。</li>
    ...
    /**
     * @param array $Definitions 图片处理模板标识列表。长度限制：100。
