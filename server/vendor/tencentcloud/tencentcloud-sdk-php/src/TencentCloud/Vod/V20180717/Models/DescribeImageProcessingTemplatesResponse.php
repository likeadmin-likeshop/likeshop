 ...
 * @method array getImageProcessingTemplateSet() 获取图片处理模板详情列表。
 * @method void setImageProcessingTemplateSet(array $ImageProcessingTemplateSet) 设置图片处理模板详情列表。
...
class DescribeImageProcessingTemplatesResponse extends AbstractModel
{
     ...
     * @param array $ImageProcessingTemplateSet 图片处理模板详情列表。
