 ...
 *
 * @method array getBandwidthPackageBillBandwidthSet() 获取当前计费用量
 * @method void setBandwidthPackageBillBandwidthSet(array $BandwidthPackageBillBandwidthSet) 设置当前计费用量
...
class DescribeBandwidthPackageBillUsageResponse extends AbstractModel
{
    ...
    /**
     * @param array $BandwidthPackageBillBandwidthSet 当前计费用量
