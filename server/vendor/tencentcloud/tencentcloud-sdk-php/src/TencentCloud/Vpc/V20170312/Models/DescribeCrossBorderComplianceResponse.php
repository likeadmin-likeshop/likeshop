 ...
 *
 * @method array getCrossBorderComplianceSet() 获取合规化审批单列表。
 * @method void setCrossBorderComplianceSet(array $CrossBorderComplianceSet) 设置合规化审批单列表。
 * @method integer getTotalCount() 获取合规化审批单总数。
 * @method void setTotalCount(integer $TotalCount) 设置合规化审批单总数。
...
class DescribeCrossBorderComplianceResponse extends AbstractModel
{
    ...
    /**
     * @param array $CrossBorderComplianceSet 合规化审批单列表。
     * @param integer $TotalCount 合规化审批单总数。
