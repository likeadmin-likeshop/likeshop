 ...
 * @method void setOldCidrBlocks(array $OldCidrBlocks) 设置待删除的辅助CIDR。CIDR数组，格式如["10.0.0.0/16", "172.16.0.0/16"]，入参NewCidrBlocks和OldCidrBlocks至少需要其一。
 */
class ModifyAssistantCidrRequest extends AbstractModel
{
    ...
    /**
     * @var array 待添加的辅助CIDR。CIDR数组，格式如["10.0.0.0/16", "172.16.0.0/16"]，入参NewCidrBlocks和OldCidrBlocks至少需要其一。
     */
    public $NewCidrBlocks;

    /**
     * @var array 待删除的辅助CIDR。CIDR数组，格式如["10.0.0.0/16", "172.16.0.0/16"]，入参NewCidrBlocks和OldCidrBlocks至少需要其一。
     */
