        ...
        <view class="main bg-primary">
            <view class="goods-list">
                <navigator
                    ...
                    :key="index"
                    class="goods-item row mt20 bg-white"
                    hover-class="none"
                        ...
                        <view class="dec row">
                            <view class="group mr20 row">
                                <view class="group-img row-center">
                                    <image
                                        class="icon-sm"
                                        src="../../static/images/icon_group_white.png"
                                    ></image>
                                </view>
...
import { getGroupList } from '@/api/activity'
...
export default {
    ...
    methods: {
        async getGroupListFun() {
            try {
                let { page, groupList, status } = this
