        ...
        <view class="aside">
            <scroll-view style="height: 100%" scroll-y="true" scroll-with-animation="true">
                <block v-for="(item, index) in cateList" :key="index">
                    <view
                        :class="'one-item sm ' + (index == selectIndex ? 'active' : '')"
            ...
            >
                <view class="main-wrap">
                    ...
                    <view class="cate-two mt20" v-if="currentType">
                        <view
                            v-for="(sitem, sindex) in cateTwoList"
                            :key="sindex"
                            class="two-item bg-white mb20"
                        >
                            <navigator
                            ...
                            <view class="three-list row wrap">
                                <navigator
                                    v-for="(titem, tindex) in sitem.sons"
                                    :key="tindex"
                                    class="three-item column-center mb20"
                                    hover-class="none"
                        ...
                        <view class="goods-list">
                            ...
                            >
                                ...
                                <view class="flex1 ml20 mr10">
                                    ...
                                    <view
                                        class="muted"
                                        v-if="item.market_price && item.market_price != 0"
                                    >
...
export default {
    ...
    methods: {
        ...
        async getGoodsSearchFun() {
            let { page, goodsList, priceSort, saleSort, status, cateList, selectIndex } = this
    ...
    computed: {
        ...
        currentType() {
            const { cateList, selectIndex } = this
