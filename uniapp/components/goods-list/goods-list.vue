    ...
    <view class="goods-list">
        <view v-if="type === 'double'" class="goods-double row-between">
            <navigator
                ...
                :key="index"
                class="item bg-white mt20"
                hover-class="none"
                open-type="navigate"
                :url="
                    '/pages/goods_details/goods_details?id=' + (isBargain ? item.goods_id : item.id)
                "
            >
        ...
        <view v-if="type === 'hot'" class="goods-hot">
            ...
            >
                ...
                <image
                    class="paixu"
                    :src="'/static/images/No.' + (index < 3 ? index : 3) + '.png'"
                ></image>
