	...
	<view class="goods-details">
		...
		<view v-else class="contain">
			<product-swiper :imgUrls="swiperList"></product-swiper>
				...
				<view class="coupons row mt20 bg-white" style="align-items: flex-start;" @tap="onShowCoupons" v-if="couponList.length">
				...
				<view class="spec row bg-white mt20"  @tap="showSpecFun(0)">
					...
					<view class="line1 mr20" style="flex: 1;">{{checkedGoods.spec_value_str}}</view>
					<image class="icon-sm" src="/static/images/arrow_right.png"></image>
				</view>
				...
				<view class="footer row bg-white fixed">
					...
					<button class="btn column-center" hover-class="none" @tap="collectGoods">
