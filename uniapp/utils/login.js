import { silentLogin } from '@/api/app'
import { isWeixinClient, currentPage, trottle, tabbarList } from './tools'
...
async function _wxMnpLogin() {
    const { register_setting_must_bind_mobile } = store.getters.appConfig
    ...
    // 需要强制绑定手机号
    if (register_setting_must_bind_mobile && !loginData.mobile) {
        return
    }
